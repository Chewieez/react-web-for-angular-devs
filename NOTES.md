...
- **Lesson Formatting Conventions**:
  ...
  - Always include a top header navigation bar (`<nav class="lesson-nav">`) with `<a href="../index.html" class="nav-home">&larr; Course Overview</a>` and previous/next lesson links matching the footer navigation.
